...
package com.example.mynavigation.rewx.databinding;
...
import com.example.mynavigation.rewx.R;
...
public final class ContentMainBinding implements ViewBinding {
  ...
  private ContentMainBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnAction,
      @NonNull CardView card, @NonNull TextView title) {
  ...
  public static ContentMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ContentMainBinding((ConstraintLayout) rootView, btnAction, card, title);
    }
